...
import com.sun.dm.di.bulkloader.exceptions.ProcessingException;
...
public class PackageTree {
    ...
    public PackageTree(Object objValue) throws ProcessingException {
        if (objValue == null) {
            throw new ProcessingException(mLocalizer.t("UTL500: Object value " + "cannot be null for root node."));
        }
